...
**If custom review agents exist** in `.opencode/agents/`: Use **Parallel Review** (4 agents, 40-50% faster)
...
Read @AGENTS.md and project README for standards.
...
Check for: logic errors, security issues, performance problems, code quality (DRY, naming, types), standards compliance (AGENTS.md conventions, linting, testing patterns).
