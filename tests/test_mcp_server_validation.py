...
class TestValidateBranchScenarioLookup:
    ...
    def test_unknown_scenario_returns_failure(self):
        ...
        result = server.validate_branch("NONEXISTENT_SCENARIO")

        assert result["success"] is False
        assert "not found" in result.get("error", "").lower()

    def test_known_scenario_returns_success(self):
        """Known scenario ID returns success payload with expected fields."""
        server = MCPServer()

        result = server.validate_branch("S001")
...
class TestValidateBranchScenarioContext:
    ...
    def test_scenario_feature_flags_honored(self):
        """
        ...
        result = server.validate_branch("S004")

        assert result["success"] is True
        assert result["provider"] == "supabase"

    def test_scenario_provider_status_honored(self):
        """
        ...
        result = server.validate_branch("S013")
...
class TestValidateBranchGating:
    ...
    def test_non_validation_scenario_no_forced_branch(self):
        """
    ...
    def test_validation_tag_scenario_gated_without_debug(self):
        """
        ...
        result = server.validate_branch("S027")
    ...
    def test_validation_tag_scenario_allowed_with_debug(self):
        """
...
class TestValidateBranchResponseFormat:
    ...
    def test_branch_match_boolean(self):
    ...
    def test_action_match_boolean(self):
